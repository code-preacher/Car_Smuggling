                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            ...
                            <span class="brand-logo">CAR SMUGGLING DETECTION SYSTEM</span>
                        </a>
                    </div>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInUp" style="font-size: 30px;">Welcome to CAR SMUGGLING DETECTION SYSTEM! </h1>
                            <p class="intro-text wow animated slideInUp"></p>
                            <p class="intro-text wow animated slideInUp"></p>
                            <a href="track.php" class="btn btn-default btn-lg">Verify</a>
                    ...
                    <div class="item">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p class="intro-text wow animated slideInUp">Verification to keep in check ....?</p>
                ...
                <div class="mouse"></div>
                           ...
                           <!--  <div class="col-md-12 text-center" style="background-color: #000;color: #fff;padding: 10px;font-weight: bolder;">
                                &copy; 2021.CAR SMUGGLING DETECTION SYSTEM! All rights reserved.
                            </div> /.col-md-12 --> 
